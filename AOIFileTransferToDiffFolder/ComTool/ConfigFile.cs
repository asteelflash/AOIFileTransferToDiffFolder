...
namespace AOIFileTransferToDiffFolder.ComTool
{
    class ConfigFile
    {
        ...
        public string GetConfigValue(string key)
        {
            ...
            return GetKeyValue(string.Format("{0}/{1}", configBasePath, key));
        }
        ...
        public void DeleteConfigKey(string key)
        {
            ...
            var node = doc.SelectSingleNode(string.Format("{0}/{1}", configBasePath, key));
            if (node == null) return;
